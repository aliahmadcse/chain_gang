...
<dl>
  <dt>Weight (kg)</dt>
  <dd><input type="text" name="bicycle[weight_kg]" value="<?= $bicycle->weight_kg; ?>" /></dd>
</dl>

<dl>
  <dt>Price</dt>
  <dd>$ <input type="text" name="bicycle[price]" size="18" value="<?= $bicycle->price; ?>" /></dd>
</dl>

<dl>
  <dt>Description</dt>
  <dd><textarea name="bicycle[description]" rows="5" cols="50"> <?= $bicycle->description; ?></textarea></dd>
</dl>